...
//enumération permettant de choisir le type de bruit à créer depuis l'interface unity
...
public class Noise : MonoBehaviour {
    ...
    //permet de choisir la dimension du valueNoise
    ...
    //permet de choisir la dimension du PerlinNoise
    ...
    //permet de choisir entre valueNoise et PerlinNoise
    public static NoiseMethod[][] noiseMethods = {
        valueMethods,
        perlinMethods
    };

    //Table de hashage sur laquelle est basé le calcul du bruit
    ...
    //fonction permettant de lisser le rendu du calcul du bruit après l'interpolation linéaire de la forme 6t^5 - 15 t^4 + 10t^3
    private static float Smooth(float t)
    {
        return t * t * t * (t * (t * 6f - 15f) + 10f);
    }

    //Produit scalaire à 2 dimensions
    private static float Dot(Vector2 g, float x, float y)
    {
        return g.x * x + g.y * y;
    }

    //Produit scalaire à 3 dimensions
